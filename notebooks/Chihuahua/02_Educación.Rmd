...
aprendizaje_ambos <- full_join(select(aprendizaje_basica, -turno),
                         select(aprendizaje_superior, -turno), by="cct") %>% 
  ...
  select(cct, rep_matematicas, rep_lenguaje,
...
desempeño <- full_join(caracterizacion,trayectoria,
  ...
  full_join(aprendizaje_ambos, by=c("cct")) %>% 
